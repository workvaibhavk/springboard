...
export default function Page() {
  ...
  return (
    <div className="overflow-x-hidden bg-[#fff]">
      ...
      <section
        id="main"
        className="flex flex-col h-[100%] md:flex-row items-center w-11/12 md:w-10/12 m-auto pt-24 pb-24 md:pt-32 md:pb-20 gap-8"
      >
        <div className="w-100 md:w-11/18 flex flex-col gap-[30px] items-center md:items-start">
          <h1 className="text-[42px] leading-[2.5rem] md:leading-[4rem]  md:text-7xl inter text-gray-900">
            Master New Skills
            <br /> with SpringBoard
          </h1>
          <p className="text-center md:text-start w-11/12 md:w-10/12 text-gray-700">
            Join a global community of learners and experts. From foundational
            concepts to advanced mastery, discover tailored learning paths that
            empower you to grow at your own pace
          </p>
        ...
        <div className="flex justify-center w-15/18 md:w-7/18">
          <Image src="/artt.png" alt="img" width={700} height={700} />
        </div>
      </section>

      <section
        id="numbers"
        className="w-11/12 h-[100%] m-auto ubuntu-bold md:p-4 py-0"
      >
        <h2 className="text-5xl md:text-6xl text-center font-bold pt-5 pb-15 text-gray-900">
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center gap-8">
          <div>
            ...
            <div className="self-center items-center flex flex-col">
              <h2 className="text-2xl leading-none font-bold pt-3 capitalize text-gray-900">
                98% learners
              </h2>
      ...
      <section
        id="founder-quotes"
        className="py-10 h-[100%] w-10/12 m-auto ubuntu-bold flex flex-col"
      >
        <h2 className="text-5xl md:text-6xl text-center font-bold pt-15 pb-10 text-gray-900">
          Words From Our Founders
        </h2>

        <div className="bg-[#d4eafa] w-9/10 md:w-5/10 p-6 rounded-3xl m-4 text-xl text-gray-900">
          Our emphasis is on the development of people, especially around
          digital talent at scale, technology for good, diversity and inclusion,
          and energizing the communities we work in.
        ...
        <div className="bg-[#FBD2D2] w-9/10 md:w-5/10 p-6 rounded-3xl m-4 self-end text-xl text-gray-900">
          Infosys will expand reskilling initiatives to empower 10 million plus
          people with digital skills and 80 million plus lives with technology
          for good programs in e-governance, healthcare and education.
          <div className="text-right text-base text-gray-700">
