...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="flex w-[100%] md:w-11/12 mx-auto justify-between items-center py-3 md:py-4 left-0 right-0 fixed top-0 bg-white z-50 ">
        <div className="block md:hidden px-4 w-20">
          <Image src="/brand-mini.png" alt="img" width={456} height={350} />
        </div>
        <div>
          <Image
        ...
        <div className="hidden md:flex roboto-main font-semibold text-lg gap-10 w-120 justify-evenly">
          <Link
            href="/xyz"
            className="relative text-gray-700 hover:text-black transition-colors duration-300 cursor-pointer group"
          >
            About
        ...
        <div className="fixed top-[80px] left-0 right-0 bg-white z-40 md:hidden shadow-lg transition-transform duration-300">
          <div className="flex flex-col p-6 gap-4">
            <Link
              ...
              href="/xyz"
              className="text-gray-700 hover:text-black py-2 border-b border-gray-200"
            >
              About
            </Link>
            <Link
